...
const mockUploadsService = {
  // 💡 Cast jest.fn() to 'any' to bypass strict signature check for your return payload
  ...
  getPresignedReadUrl: jest.fn() as any,
  softDeleteFile: jest.fn() as any,
  isLocalFallbackActive: jest.fn() as any,
  getLocalStoreDir: jest.fn() as any,
  getMyFiles: jest.fn() as any,
};
